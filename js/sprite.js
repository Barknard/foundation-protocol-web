'use strict';
/* SVG sprite — UI icons only. Injected as the first child of <body>.
   (Exercise figures are drawn live by the parametric skeleton/gait engine in figure.js —
   the old per-exercise flip-book symbols that used to live here are gone with it.) */
